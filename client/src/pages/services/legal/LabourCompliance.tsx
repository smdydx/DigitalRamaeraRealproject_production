      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            className="legal-hero flex flex-col items-center justify-center text-center relative overflow-hidden rounded-2xl"
          >
          ...
          >
            {[
              ...
              <div
                key={index}
                className="p-6 bg-zinc-900/50 rounded-xl border border-green-500/10 hover:border-green-500/30 transition-all"
              >
          ...
          >
            <h2 className="text-3xl font-bold text-center">
              Why Choose SOFTBEEM for Labour Law Compliance?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="flex items-start gap-4 p-6 bg-zinc-900/50 rounded-xl border border-green-500/10"
                >
          ...
          >
            <h2 className="text-3xl font-bold">
              Get Expert Labour Law Compliance Support!
            </h2>
