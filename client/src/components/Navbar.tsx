                  ...
                  {link.name === "Contact Us" && (
                    <div className="hidden md:flex items-center gap-4 lg:gap-6">
                      <a 
                        ...
                        className="flex items-center justify-center p-2.5 rounded-lg bg-green-500/10 hover:bg-green-500/20 text-green-400 transition-all transform hover:scale-105 border border-green-500/30"
                      >
                      ...
                      <Button 
                        ...
                        variant="outline" 
                        className="hidden md:flex items-center justify-center gap-2 px-4 py-2 bg-green-500/10 hover:bg-green-500/20 text-green-400 border-green-500/30"
                        size="icon"
                      >
