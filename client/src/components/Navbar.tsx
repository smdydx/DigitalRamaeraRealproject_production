...
//   return (
//     <header
//       className={`fixed top-0 w-full z-50 transition-all duration-300 h-16 sm:h-20 md:h-24 flex items-center ${
//         isScrolled
//           ? "bg-gradient-to-r from-black/90 via-zinc-900/90 to-black/90 backdrop-blur-lg border-b border-green-500/10 shadow-lg shadow-green-500/5"
//           : "bg-gradient-to-r from-black/80 via-zinc-900/80 to-black/80 backdrop-blur-md"
//       }`}
//     >
...
//             transition={{ duration: 0.2 }}
//             className="fixed top-16 sm:top-20 md:top-24 left-0 right-0 bg-zinc-900/95 backdrop-blur-xl border-t border-green-500/20 overflow-y-auto max-h-[calc(100vh-4rem)] z-50 shadow-lg shadow-black/50"
//           >
...
const Navbar = () => {
  ...
  return (
    <header
      className={`fixed top-0 w-full z-50 transition-all duration-300 h-20 sm:h-24 lg:h-28 flex items-center ${
        isScrolled
