                  ...
                  {link.name === "Contact Us" && (
                    <div className="hidden md:flex items-center gap-4 lg:gap-6">
                      <a 
                        ...
                        className="flex items-center justify-center p-2 lg:p-3 rounded-lg bg-green-500/10 hover:bg-green-500/20 text-green-400 transition-all transform hover:scale-105"
                      >
                      ...
                      <Button 
                        ...
                        variant="outline" 
                        className="hidden md:flex items-center justify-center p-2 md:px-4"
                        size="icon"
                      >
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 p-4 border-b border-green-500/10">
              <a 
                href="tel:+911169310715" 
                className="flex items-center justify-center p-2 rounded-lg bg-green-500/10 hover:bg-green-500/20 text-green-400 transition-all flex-1"
              >
                <PhoneCall className="w-5 h-5" />
              </a>
              <a 
